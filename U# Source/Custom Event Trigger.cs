...
public class EventTrigger : UdonSharpBehaviour
{
    /* Dev Notes:
    ...
    void Interact() { if (Event_Interact) { SendCustomEvent("Run_interact_toggle"); } }
    ...
    void OnPickupUseUp() { if (Event_OnPickupUseUp) { SendCustomEvent("Run_0"); } }
